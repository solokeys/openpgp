...
_SRCS=aes.c asn1parse.c asn1write.c \
            ...
            md.c md2.c md4.c md5.c md_wrap.c oid.c

# MBEDTLS_SRCS := $(patsubst %.cpp, $(OBJ_DIR)/%.cpp, $(notdir $(_SRCS)))
MBEDTLS_SRCS := $(foreach var, $(_SRCS), $(MBEDTLS_DIR)$(var))

MBEDTLS_INCLUDE= -I. -Imbedtls/include/ -Imbedtls/crypto/library -Imbedtls/crypto/include/
MBEDTLS_CONFIG= -DMBEDTLS_CONFIG_FILE=\"libs/mbedtls/mbedtls_config.h\"
